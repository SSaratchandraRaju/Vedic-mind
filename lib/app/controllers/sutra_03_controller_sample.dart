...
class Sutra03Controller extends GetxController {
      ...
      practiceProblems.value = [
        {
          "problem": "12×13",
          "answer": "156",
          "hint": "2×3=6, 1×3+2×1=5, 1×1=1",
        },
        {
          "problem": "34×25",
          "answer": "850",
          "hint": "Crosswise middle digits",
        },
  ...
  Future<void> _loadUserProgress() async {
    try {
      final userId = Get.find<AuthController>()
          .currentUserId
          .value; // Assuming auth controller exists
  ...
  void _completePracticeSection() {
    final accuracy = (practiceScore.value / practiceProblems.length * 100)
        .round();
  ...
  Future<void> _saveProgress() async {
    try {
      ...
      await _firestore.collection('users').doc(userId).update({
        ...
        'sutra_3_score': {
          'practice_accuracy':
              (practiceScore.value / practiceProblems.length * 100).round(),
