                        ...
                        child: Obx(
                          () => GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: controller.selectedAuthMethod.value == 0
                                    ? AppColors.primary
                                    : Colors.transparent,
                                borderRadius: BorderRadius.circular(12),
                              ),
                              child: Text(
                                ...
                                style: TextStyle(
                                  ...
                                  color:
                                      controller.selectedAuthMethod.value == 0
                                      ? Colors.white
                        ...
                        child: Obx(
                          () => GestureDetector(
                            ...
                            child: Container(
                              padding: const EdgeInsets.symmetric(vertical: 12),
                              decoration: BoxDecoration(
                                color: controller.selectedAuthMethod.value == 1
                                    ? AppColors.primary
                                    : Colors.transparent,
                                borderRadius: BorderRadius.circular(12),
                              ),
                              child: Text(
                                ...
                                style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w600,
                                  color:
                                      controller.selectedAuthMethod.value == 1
                                      ? Colors.white
                                      : AppColors.textSecondary,
                                  fontFamily: 'Poppins',
                                ),
