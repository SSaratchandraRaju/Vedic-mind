...
class InteractiveLessonViewController extends GetxController {
  ...
  void _loadPracticeSteps() {
    if (sutra.practice.isNotEmpty) {
      ...
      practiceSteps = VedicSutraExamples.getPracticeSteps(
        sutra.sutraId,
        problem,
      );
  ...
  void _handlePracticeComplete() {
    ...
    final xpReward = attempts.value == 0
        ? 100
        : (attempts.value <= 2 ? 75 : 50);
    courseController.awardXP(xpReward);

    // Check if sutra should be auto-completed based on validation
    courseController.checkAndCompleteSutra(sutra.sutraId);
...
class InteractiveLessonView extends GetView<EnhancedVedicCourseController> {
  ...
  Widget build(BuildContext context) {
    final lessonController = Get.put(
      InteractiveLessonViewController(controller),
    );
          ...
          Obx(
            () => Container(
              ...
              child: FractionallySizedBox(
                ...
                widthFactor:
                    (lessonController.currentStep.value + 1) /
                      ...
                      children: [
                        ...
                        Obx(
                          () => lessonController.ttsEnabled.value
                              ? InkWell(
                                  onTap: () =>
                                      lessonController.speakCurrentStep(),
                                  child: Container(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  lessonController
                                      .example
                                      .steps[lessonController.currentStep.value]
                                      .description,
                ...
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () {
                        if (lessonController.currentStep.value <
                            lessonController.example.steps.length - 1) {
                          lessonController.nextStep();
                        } else {
                          // Mark interactive lesson as completed
                          lessonController.courseController
                              .markInteractiveCompleted(
                                lessonController.sutra.sutraId,
                              );
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            lessonController.currentStep.value <
                                    lessonController.example.steps.length - 1
                                ? 'Next'
                                : 'Start Practice',
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Obx(() {
                ...
                final problem = lessonController
                    .sutra
                    .practice[lessonController.currentProblemIndex.value];
                final currentStep = lessonController
                    .practiceSteps[lessonController.currentPracticeStep.value];
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            IconButton(
                              onPressed: () =>
                                  lessonController.toggleStepHint(),
                              icon: Icon(
                            ...
                            if (lessonController.ttsEnabled.value &&
                                lessonController.showStepHint.value)
                              IconButton(
                                onPressed: () {
                                  lessonController.ttsService.speak(
                                    currentStep.hint,
                                  );
                                },
                                icon: const Icon(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(
                          color: lessonController.showFeedback.value
                      ...
                      child: Text(
                        lessonController
                                .userStepAnswers[lessonController
                                    .currentPracticeStep
                                    .value]
                                .isEmpty
                            ? 'Your answer...'
                            : lessonController.userStepAnswers[lessonController
                                  .currentPracticeStep
                                  .value],
                    ...
                    if (!lessonController.showFeedback.value ||
                      ...
                      PracticeKeyboard(
                        onCharacterPressed: (character) {
                          final current =
                              lessonController.userStepAnswers[lessonController
                                  .currentPracticeStep
                                  .value];
                          lessonController.updateStepAnswer(
                            current + character,
                          );
                        },
                        onDelete: () {
                        ...
                        onSubmit: () => lessonController.checkStepAnswer(),
