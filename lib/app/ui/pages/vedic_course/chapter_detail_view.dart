                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: chapterColor.withOpacity(0.3),
                      ),
                    ),
                    child: Row(
                      children: [
            ...
            sliver: SliverList(
              delegate: SliverChildBuilderDelegate(
                (context, index) {
                  ...
                  final isCompleted = controller.isLessonCompleted(lesson.lessonId);
                  final isLocked = index > 0 && 
                      !controller.isLessonCompleted(chapter.lessons[index - 1].lessonId);
