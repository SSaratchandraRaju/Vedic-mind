...
class FactorizationFinaleController extends SutraGameController {
  ...
  void _handleWrongAnswer() {
    ...
    showFeedback('❌ Wrong! Factors: ${correct[0]}, ${correct[1]}', isCorrect: false);
  }
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            controller.userP.value.isEmpty ? '_' : controller.userP.value,
                            style: const TextStyle(
                              fontSize: 28,
                              fontWeight: FontWeight.bold,
                            ),
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            controller.userQ.value.isEmpty ? '_' : controller.userQ.value,
                            style: const TextStyle(
                              fontSize: 28,
                              fontWeight: FontWeight.bold,
                            ),
