...
class ProductSumSpotterController extends SutraGameController {
  ...
  void _handleWrongAnswer() {
    ...
    showFeedback('❌ Wrong! Try: x=${correct[0]}, y=${correct[1]}', isCorrect: false);
  }
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          controller.userX.value.isEmpty ? '_' : controller.userX.value,
                          style: const TextStyle(
                            fontSize: 36,
                            fontWeight: FontWeight.bold,
                          ),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          controller.userY.value.isEmpty ? '_' : controller.userY.value,
                          style: const TextStyle(
                            fontSize: 36,
                            fontWeight: FontWeight.bold,
                          ),
