...
class SquareDashController extends SutraGameController {
  ...
  void _generateNewProblem() {
    final available = numbers.where((n) => !answeredNumbers.contains(n)).toList();
  ...
  void _handleCorrectAnswer() {
    ...
    showFeedback('🔥 Correct! +$points (${combo.value}x combo)', isCorrect: true);
    _generateNewProblem();
  }
  ...
  void _handleWrongAnswer() {
    resetCombo();
    loseLife();
    showFeedback('❌ Wrong! Answer: ${_calculateCorrectAnswer()}', isCorrect: false);
  }
