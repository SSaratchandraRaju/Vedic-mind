...
class SutraProgress {
  ...
  final bool hasCompletedInteractive;
  ...
  SutraProgress({
    ...
    this.hasCompletedInteractive = false,
  ...
  double get accuracy {
    ...
    final finalAccuracy = (baseAccuracy - hintPenalty - wrongPenalty).clamp(
      0.0,
      100.0,
    );
  ...
  factory SutraProgress.fromJson(Map<String, dynamic> json) {
    return SutraProgress(
      ...
      hasCompletedInteractive: json['has_completed_interactive'] ?? false,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'has_completed_interactive': hasCompletedInteractive,
  ...
  SutraProgress copyWith({
    ...
    return SutraProgress(
      ...
      hasCompletedInteractive:
          hasCompletedInteractive ?? this.hasCompletedInteractive,
