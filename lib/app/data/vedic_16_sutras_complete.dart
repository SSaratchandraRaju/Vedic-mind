...
const vedic16SutrasComplete = {
  "course_metadata": {
    ...
    "description":
        "Master all 16 canonical Vedic Mathematics sutras through interactive, animation-rich lessons",
    "total_sutras": 16,
  ...
  "analytics_events": [
    {
      ...
      "payload": ["sutra_id", "user_id", "timestamp"],
    },
    {
      "event": "step_revealed",
      "payload": ["sutra_id", "step_index", "time_to_reveal_ms"],
    },
    {
      "event": "practice_submitted",
      "payload": ["sutra_id", "problem_id", "is_correct", "attempts"],
    },
    {
      "event": "quiz_completed",
      "payload": ["sutra_id", "score", "time_taken_ms"],
    },
    {
      "event": "challenge_failed",
      "payload": ["sutra_id", "final_score", "retry_count"],
    },
    {
      "event": "badge_earned",
      "payload": ["badge_id", "sutra_id", "xp_awarded"],
    },
    {
      "event": "mini_game_started",
      "payload": ["sutra_id", "game_type"],
    },
    {
      "event": "mini_game_completed",
      "payload": ["sutra_id", "score", "combo_max"],
    },
    {
      "event": "lesson_completed",
      "payload": ["sutra_id", "completion_time_ms", "accuracy_percent"],
    },
  ],
  ...
  "sutras": [
    {
      ...
      "objective":
          "Master instant squaring of numbers ending in 5 using the 'one more than previous' technique",
      ...
      "intuitive_explanation":
          "Imagine cutting a square garden into sections. When the side length ends in 5, you can always split it into a rectangle (previous number × next number) plus a small 25-square corner. For 35×35: think '3 lots of 4 hundreds' (3×4=12) plus the corner (25) = 1225. The magic pattern always works!",
      ...
      "interactive_example": {
        ...
        "conventional_solution":
            "65 × 65 = (60×60) + 2(60×5) + (5×5) = 3600 + 600 + 25 = 4225 (6 steps)",
        "sutra_solution_steps": [
          ...
          },
          {
            ...
            "animation": {
              "type": "svg_path",
              "description":
                  "Digit '5' fades and slides right while '6' scales up",
              "duration_ms": 280,
          ...
          },
          {
            ...
            "comparison_note":
                "Conventional: 6 steps, 30+ seconds. Vedic: 2 seconds!",
          },
        ],
      },
      ...
      "ui_animation_spec": {
        ...
        "high_animation_notes": {
          "lottie_files": [
            ...
            "multiplication_burst.json",
            "success_celebration.json",
          ],
          "svg_animations": ["digit_morph.svg", "crosswise_sweep.svg"],
          "particle_effects": [
            "sparkle_trail (on swipe)",
            "confetti_burst (on correct)",
            "glow_pulse (on focus)",
          ],
          "timing_recommendations":
              "Step transitions: 220-320ms spring. Number morphs: 180ms ease-out. Celebrations: 800-1200ms",
          "motion_easing":
              "Spring with damping 0.7 for snaps, cubic-bezier(0.4, 0.0, 0.2, 1) for slides",
          "accessibility_fallback":
              "Reduce all animations to simple fades (200ms) when 'reduce motion' is enabled",
        },
        "audio_cues": [
      ...
      "mini_game": {
        ...
        "description":
            "Square all numbers ending in 5 as fast as you can! Build combos for bonus points.",
        "mechanics": {
          "type": "timed_puzzle",
          "duration_seconds": 90,
          "problems_pool": 15,
      ...
      "micro_quiz": [
        {
          ...
          "correct_answer": "8 × 9",
          "explanation":
              "Take 8 (the digit before 5), multiply by one more: 8 × 9 = 72, then append 25 = 7225",
        },
        {
          "question_id": "q1_2",
          ...
          "correct_answer": "25",
          "explanation":
              "The last two digits are always 25 for squares of numbers ending in 5",
        },
        {
          "question_id": "q1_3",
      ...
      "badge_reward": {
        ...
        "xp_awarded": 100,
        "unlock_message":
            "🎉 You can now square any number ending in 5 instantly!",
      },
